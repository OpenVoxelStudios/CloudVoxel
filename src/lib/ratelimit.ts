 ...
 */
export default function rateLimit(db: LibSQLDatabase<Record<string, never>> & { $client: Client }, ip: string, key: string, limit: number, duration: number): Promise<boolean> {
