    ...
    <section className="relative overflow-hidden py-20 sm:py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in-up animation-delay-400">
          ...
          <Link
            href="https://github.com/OpenVoxelStudios/CloudVoxel/"
            target="_blank"
          >
            <Button
              size="lg"
              variant="outline"
              className="text-blue-400 border-blue-400 hover:bg-blue-400/10 transition-colors duration-300"
            >
              Start Self-Hosting
            </Button>
          </Link>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div className="animate-fade-in-left">
            ...
            <p className="text-gray-300 mb-6">
              CloudVoxel is more than just an online file hosting service. It is
              an{" "}
              <Link
                href={"https://github.com/OpenVoxelStudios/CloudVoxel"}
                target="_blank"
              ...
              local-first solution to file sharing. Our goal is to provide the
              code and tools necessary for anyone to host their own cloud
              storage service for their needs.
            </p>
            <p className="text-gray-300 mb-6">
              This is the default landing page when you just downloaded the
              project. Good news, it works! You can edit the{" "}
              <code>src/app/page.tsx</code> file to customize this page to your
              liking or disable it in <code>clientconfig.ts</code>.
            </p>
          </div>
          <div className="mt-10 lg:mt-0 flex justify-center animate-fade-in-right">
            <Image
              src={clientconfig.websiteLogo}
              alt="CloudVoxel Illustration"
...
function FeatureCard({
  ...
  return (
    <div
      className={`bg-gray-700 p-6 rounded-lg shadow-lg transform transition duration-500 hover:scale-105 animate-fade-in-up`}
...
function RoadmapSection() {
  return (
    <section id="roadmap" className="py-20 sm:py-32 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          href="https://github.com/orgs/OpenVoxelStudios/projects/4/views/1"
          target="_blank"
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-white mb-12 animate-fade-in-up underline">
            Project Roadmap
          </h2>
        </Link>
    ...
    <section id="contact" className="py-20 sm:py-32 bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
          CloudVoxel is developped and maintained by{" "}
          <Link href="mailto:kubik@openvoxel.studio" className="underline">
            Kubik
          </Link>
