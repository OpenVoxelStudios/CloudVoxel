...
export default function UserDropdown({ session }: { session: Session }) {
  ...
  const AlertPasskey = useMemo(() => {
    ...
    return (
      <AlertDialog
        open={deletePasskeyDialog}
        onOpenChange={setDeletePasskeyDialog}
      >
        <AlertDialogContent className="bg-gray-800 border border-gray-700">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              This will delete your Passkey. You can still create a new one
              later.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
    ...
    <>
      ...
      <DropdownMenu>
        ...
        >
          ...
          {hasPasskey === undefined ? null : hasPasskey ? (
            <DropdownMenuItem
            ...
            <DropdownMenuItem
              ...
              onClick={() =>
                passkeySignIn("passkey", { action: "register" }).then(() => {
                  setHasPasskey(true);
                  toast({
