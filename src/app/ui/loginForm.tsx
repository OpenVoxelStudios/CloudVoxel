  ...
  return (
    <div
      className={
        ...
        providerMap.filter((p) => p.id != "credentials" && p.id != "passkey")
          .length > 0
    ...
    >
      ...
      {providerMap.filter((p) => p.id != "credentials" && p.id != "passkey")
        ...
        <div className="relative">
          {providerMap.some((p) => p.id == "credentials") ? (
            <div className="hidden lg:block absolute -left-4 top-0 bottom-0 w-px bg-gray-700" />
          ) : (
            ""
          )}
          {(providerMap.some((p) => p.id == "passkey") ||
                  ...
                  >
                    ...
                    >
                      {(() => {
                        ...
                        return (
                          icons[
                            provider.id.toLowerCase() as keyof typeof icons
                          ] || null
                        );
                      })()}
                      {provider.name}
