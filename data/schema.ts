...
import { AnySQLiteColumn, index, int, primaryKey, SQLiteColumn, sqliteTable, text, unique, integer } from "drizzle-orm/sqlite-core";
...
export const authenticatorsTable = sqliteTable("authenticator", {
